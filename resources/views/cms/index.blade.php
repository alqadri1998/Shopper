...
<div class="wrapper">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('cms.customer.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Show Customers</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('cms.product.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Show Products</p>
                                </a>
                            </li>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2019-2020 <a target="_blank" href="#">CMS</a>.</strong>
        All rights reserved.
